--[[
    @Code author: satan
    @Created for Private Project
    @Licensed by MIT
    @Contact on xsvtnnn@gmail.com / satanik#1000
]]
...
function clientSpeedometer.drawStandardSpeedometer()
    ...
    if isElement(clientSpeedometer.vehicle) then
...
function clientSpeedometer.drawMotorcycleSpeedometer()
    ...
    if isElement(clientSpeedometer.vehicle) then
        ...
        dxDrawImage(gui.arrow_health[1], gui.arrow_health[2], gui.arrow_health[3], gui.arrow_health[4], clientSpeedometer.textures.motorcycle.arrow_health , -30, 0, 0, tocolor(255, 255, 255, clientSpeedometer.motorcycleAlpha))
